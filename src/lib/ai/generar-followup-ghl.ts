// GHL-9.4 — Haiku: genera el copy del mensaje de follow-up por tipo × nivel.
// Todos los mensajes usan el estilo conversacional de WhatsApp, sin emojis excesivos.
...
export interface ContextoFollowup {
  ...
  nivel: number;          // 1=primer recordatorio, 2=empático, 3=social proof (pago)
...
Tono amigable y proactivo.`,
    ...
    2: `Segundo y último intento para retomar contacto con el lead.
Escribe un mensaje muy corto y empático. Muestra que entiendes que está ocupado.
